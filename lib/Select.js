...
var Select = function (_React$Component) {
   ...
   */
		...
		value: function render() {
			...
			// wrap values
			var ValueWrapComponent = this.props.sortableValues ? _reactSortablejs2.default : function (p) {
				return _react2.default.createElement('div', p);
			};
			...
			if (this.props.sortableValues) {
				propsWrapComponent.options = {
					...
					onAdd: function onAdd(evt) {
						...
						_this9.setValue(_lodash2.default.uniqWith([].concat(_toConsumableArray(valueArray)), _lodash2.default.isEqual));
					},
				...
				propsWrapComponent.onChange = function (order, sortable, evt) {
					...
					if (from === to) {
						...
						var _valueArray$splice = _valueArray.splice(oldIndex, 1),
						    _valueArray$splice2 = _slicedToArray(_valueArray$splice, 1),
						    valueByOldIndex = _valueArray$splice2[0];

						_valueArray.splice(newIndex, 0, valueByOldIndex);
						_this9.setValue([].concat(_toConsumableArray(_valueArray)));
					}
				};
...
Select.propTypes = {
	...
	sortableValues: _propTypes2.default.bool,
	sortableGroup: _propTypes2.default.string
};
