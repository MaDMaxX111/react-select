...
var Value = function (_React$Component) {
	...
	_createClass(Value, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ 'data-value': JSON.stringify(this.props.value), className: (0, _classnames2.default)('Select-value', this.props.value.disabled ? 'Select-value-disabled' : '', this.props.value.className),
