...
class Value extends React.Component {
	...
	render () {
		return (
			<div data-value={JSON.stringify(this.props.value)} className={classNames('Select-value', this.props.value.disabled ? 'Select-value-disabled' : '', this.props.value.className)}
